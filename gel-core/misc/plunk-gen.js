...
@Component({
  ...
  template: \`
    ...
    <hr>
    <p>
      This is a demo plnkr forked from the <strong>gel-core</strong> project: Angular powered Bootstrap.
      Visit <a href="https://gel-core.github.io/" target="_blank">https://gel-core.github.io</a> for more widgets and demos.
    </p>
    <hr>
...
<body>
  <form id="mainForm" method="post" action="${plnkrUrl}">
    <input type="hidden" name="description" value="Example usage of the ${componentName} widget from https://gel-core.github.io">
${generateTags(['Angular', 'Bootstrap', 'gel-core', capitalize(componentName)])}  
